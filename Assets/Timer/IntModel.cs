...
public partial class IntModel : RealtimeModel {
    public int value {
        get {
    ...
    public delegate void PropertyChangedHandler<in T>(IntModel model, T value);
    ...
    public IntModel() : base(null) {
        _valueProperty = new ReliableProperty<int>(1, _value);
    }
